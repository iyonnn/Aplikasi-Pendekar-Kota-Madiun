...
class webbakul extends StatefulWidget {
  const webbakul({Key? key}) : super(key: key);

  @override
  _webbakulState createState() => _webbakulState();
}

class _webbakulState extends State<webbakul> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://bakul.madiunkota.go.id/';
