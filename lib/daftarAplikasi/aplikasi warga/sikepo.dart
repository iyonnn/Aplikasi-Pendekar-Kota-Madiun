...
class websikepo extends StatefulWidget {
  const websikepo({Key? key}) : super(key: key);

  @override
  _websikepoState createState() => _websikepoState();
}

class _websikepoState extends State<websikepo> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://sikepo.madiunkota.go.id/';
