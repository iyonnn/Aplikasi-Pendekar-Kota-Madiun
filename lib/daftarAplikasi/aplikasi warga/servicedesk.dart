...
class webservicedesk extends StatefulWidget {
  const webservicedesk({Key? key}) : super(key: key);

  @override
  _webservicedeskState createState() => _webservicedeskState();
}

class _webservicedeskState extends State<webservicedesk> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://servicedesk.madiunkota.go.id/';
