...
class webpecel extends StatefulWidget {
  const webpecel({Key? key}) : super(key: key);

  @override
  _webpecelState createState() => _webpecelState();
}

class _webpecelState extends State<webpecel> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://peceltumpang.madiunkota.go.id/';
