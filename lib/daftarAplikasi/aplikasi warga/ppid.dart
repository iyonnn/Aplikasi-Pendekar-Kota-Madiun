...
class webppid extends StatefulWidget {
  const webppid({Key? key}) : super(key: key);

  @override
  _webppidState createState() => _webppidState();
}

class _webppidState extends State<webppid> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://ppid.madiunkota.go.id/';
