...
class webesayur extends StatefulWidget {
  const webesayur({Key? key}) : super(key: key);

  @override
  _webesayurState createState() => _webesayurState();
}

class _webesayurState extends State<webesayur> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://esayur.madiunkota.go.id/';
