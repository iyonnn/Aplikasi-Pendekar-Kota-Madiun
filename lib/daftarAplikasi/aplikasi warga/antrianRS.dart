...
class webantrianrs extends StatefulWidget {
  const webantrianrs({Key? key}) : super(key: key);

  @override
  _webantrianrsState createState() => _webantrianrsState();
}

class _webantrianrsState extends State<webantrianrs> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://rsudkotamadiun.my.id/sogaten/';
