...
class webmatawarga extends StatefulWidget {
  const webmatawarga({Key? key}) : super(key: key);

  @override
  _webmatawargaState createState() => _webmatawargaState();
}

class _webmatawargaState extends State<webmatawarga> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://matawarga.madiunkota.go.id/';
