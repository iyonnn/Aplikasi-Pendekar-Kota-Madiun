...
class webproumkm extends StatefulWidget {
  const webproumkm({Key? key}) : super(key: key);

  @override
  _webproumkmState createState() => _webproumkmState();
}

class _webproumkmState extends State<webproumkm> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://proumkm.madiunkota.go.id/login';
