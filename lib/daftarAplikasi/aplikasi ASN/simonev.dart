...
class websimonev extends StatefulWidget {
  const websimonev({Key? key}) : super(key: key);

  @override
  _websimonevState createState() => _websimonevState();
}

class _websimonevState extends State<websimonev> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://simonev.madiunkota.go.id/login';
