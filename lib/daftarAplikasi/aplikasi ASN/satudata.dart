...
class websatudata extends StatefulWidget {
  const websatudata({Key? key}) : super(key: key);

  @override
  _websatudataState createState() => _websatudataState();
}

class _websatudataState extends State<websatudata> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://satudata.madiunkota.go.id/';
