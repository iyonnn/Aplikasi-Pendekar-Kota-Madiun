...
class webretribusi extends StatefulWidget {
  const webretribusi({Key? key}) : super(key: key);

  @override
  _webretribusiState createState() => _webretribusiState();
}

class _webretribusiState extends State<webretribusi> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://retribusi.madiunkota.go.id/login';
