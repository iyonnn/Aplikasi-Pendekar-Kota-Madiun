...
class webaspirasirakyat extends StatefulWidget {
  const webaspirasirakyat({Key? key}) : super(key: key);

  @override
  _webaspirasirakyatState createState() => _webaspirasirakyatState();
}

class _webaspirasirakyatState extends State<webaspirasirakyat> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://dprd.madiunkota.go.id/';
