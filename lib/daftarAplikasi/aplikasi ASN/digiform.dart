...
class webdigiform extends StatefulWidget {
  const webdigiform({Key? key}) : super(key: key);

  @override
  _webdigiformState createState() => _webdigiformState();
}

class _webdigiformState extends State<webdigiform> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://digiform.madiunkota.go.id/login';
