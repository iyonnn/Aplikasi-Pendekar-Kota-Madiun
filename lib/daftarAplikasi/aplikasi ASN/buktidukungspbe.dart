// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, avoid_print, camel_case_types, library_private_types_in_public_api

import 'package:flutter/material.dart';
import 'package:flutter_inappwebview/flutter_inappwebview.dart';
import 'package:permission_handler/permission_handler.dart';

class webspbe extends StatefulWidget {
  const webspbe({Key? key}) : super(key: key);

  @override
  _webspbeState createState() => _webspbeState();
}

class _webspbeState extends State<webspbe> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://buktidukung.madiunkota.go.id/login';
