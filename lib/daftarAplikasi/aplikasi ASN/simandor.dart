...
class websimandor extends StatefulWidget {
  const websimandor({Key? key}) : super(key: key);

  @override
  _websimandorState createState() => _websimandorState();
}

class _websimandorState extends State<websimandor> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://simandor.madiunkota.go.id/';
