...
class websicakep extends StatefulWidget {
  const websicakep({Key? key}) : super(key: key);

  @override
  _websicakepState createState() => _websicakepState();
}

class _websicakepState extends State<websicakep> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://agenda.madiunkota.go.id/';
