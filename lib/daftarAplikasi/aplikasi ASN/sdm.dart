...
class websdm extends StatefulWidget {
  const websdm({Key? key}) : super(key: key);

  @override
  _websdmState createState() => _websdmState();
}

class _websdmState extends State<websdm> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://sdm.madiunkota.go.id/';
