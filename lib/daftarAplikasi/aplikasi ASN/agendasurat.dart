...
class webagendasurat extends StatefulWidget {
  const webagendasurat({Key? key}) : super(key: key);

  @override
  _webagendasuratState createState() => _webagendasuratState();
}

class _webagendasuratState extends State<webagendasurat> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://undangan.madiunkota.go.id/';
