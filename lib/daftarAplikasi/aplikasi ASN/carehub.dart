...
class webcarehub extends StatefulWidget {
  const webcarehub({Key? key}) : super(key: key);

  @override
  _webcarehubState createState() => _webcarehubState();
}

class _webcarehubState extends State<webcarehub> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://mobdin.madiunkota.go.id/login';
