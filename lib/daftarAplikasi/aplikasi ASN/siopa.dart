...
class websiopa extends StatefulWidget {
  const websiopa({Key? key}) : super(key: key);

  @override
  _websiopaState createState() => _websiopaState();
}

class _websiopaState extends State<websiopa> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://siopa.madiunkota.go.id/';
