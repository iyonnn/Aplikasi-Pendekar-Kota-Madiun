...
class webanalisaberita extends StatefulWidget {
  const webanalisaberita({Key? key}) : super(key: key);

  @override
  _webanalisaberitaState createState() => _webanalisaberitaState();
}

class _webanalisaberitaState extends State<webanalisaberita> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://analisaberita.madiunkota.go.id/';
