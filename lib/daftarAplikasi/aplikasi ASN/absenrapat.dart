...
class webabsenrapat extends StatefulWidget {
  const webabsenrapat({Key? key}) : super(key: key);

  @override
  _webabsenrapatState createState() => _webabsenrapatState();
}

class _webabsenrapatState extends State<webabsenrapat> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://erapat.madiunkota.go.id/';
