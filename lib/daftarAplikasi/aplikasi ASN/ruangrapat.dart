...
class webruangrapat extends StatefulWidget {
  const webruangrapat({Key? key}) : super(key: key);

  @override
  _webruangrapatState createState() => _webruangrapatState();
}

class _webruangrapatState extends State<webruangrapat> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://ruangrapat.madiunkota.go.id/';
