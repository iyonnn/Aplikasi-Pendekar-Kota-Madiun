...
class weblppd extends StatefulWidget {
  const weblppd({Key? key}) : super(key: key);

  @override
  _weblppdState createState() => _weblppdState();
}

class _weblppdState extends State<weblppd> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://lppd.madiunkota.go.id/';
