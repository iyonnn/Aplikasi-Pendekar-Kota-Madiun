...
class websilapling extends StatefulWidget {
  const websilapling({Key? key}) : super(key: key);

  @override
  _websilaplingState createState() => _websilaplingState();
}

class _websilaplingState extends State<websilapling> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://silapling.madiunkota.go.id/';
