...
class webgedungdiklat extends StatefulWidget {
  const webgedungdiklat({Key? key}) : super(key: key);

  @override
  _webgedungdiklatState createState() => _webgedungdiklatState();
}

class _webgedungdiklatState extends State<webgedungdiklat> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://gedungdiklat.madiunkota.go.id/login';
