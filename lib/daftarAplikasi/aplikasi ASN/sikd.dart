...
class websikd extends StatefulWidget {
  const websikd({Key? key}) : super(key: key);

  @override
  _websikdState createState() => _websikdState();
}

class _websikdState extends State<websikd> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://sikd.madiunkota.go.id/';
