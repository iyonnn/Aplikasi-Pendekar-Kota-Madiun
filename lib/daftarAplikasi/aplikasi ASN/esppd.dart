...
class webesppd extends StatefulWidget {
  const webesppd({Key? key}) : super(key: key);

  @override
  _webesppdState createState() => _webesppdState();
}

class _webesppdState extends State<webesppd> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://esppd.madiunkota.go.id/';
