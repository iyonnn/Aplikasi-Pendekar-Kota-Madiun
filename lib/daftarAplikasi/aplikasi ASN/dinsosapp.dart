...
class webdinsosapp extends StatefulWidget {
  const webdinsosapp({Key? key}) : super(key: key);

  @override
  _webdinsosappState createState() => _webdinsosappState();
}

class _webdinsosappState extends State<webdinsosapp> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url = 'https://dinsosapp.madiunkota.go.id/';
